<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @elseif (Auth::user()->status == 'user')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('zoom-participant.index')" :active="request()->routeIs('zoom-participant.index')">
                            {{ __('Participate Meeting') }}
                        </x-nav-link>
                    </div>
                @endif
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="p-1">
                                <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="{{asset('storage/'. Auth::user()->profile_image)}}" alt="">
                            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('zoom-participant.index')" :active="request()->routeIs('zoom-participant.index')">
                {{ __('Participate Zoom') }}
            </x-responsive-nav-link>
        </div>
